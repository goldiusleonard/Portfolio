...
async def run_async_direct_processor_v0(table_config):
    try:
        ...
        # Initialize agentsprocess and pipeline
        ...
        df = db.get_new_rows(
            key_id,
            table_config.table_target_name,
            table_config.table_source_name,
        )
        pipeline = DataProcessorPipeline_v00(agentsprocess, db, df)
        ...
        # Run pipeline
        pipeline.run_all_agents_pipeline(key_id)
    ...
    logger.info("Preproceed data processor completed.")
