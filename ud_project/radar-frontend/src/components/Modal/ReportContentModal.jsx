...
const ReportContentModal = ({ isOpen, toggle, chosenContent, handleReportContents, onCloseModal }) => {
					...
					{currentStep === 1 &&
						<>
							<div className="selected-report">
								<Table
									dataKey="video_id"
									values={[chosenContent]}
									headers={contentsListHeaders}
									showHeaders={false}
									onRowClick={go2OriginalContent}
								/>
							</div>
